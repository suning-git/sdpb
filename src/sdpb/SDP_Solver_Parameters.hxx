...
struct SDP_Solver_Parameters
{
  ...
  El::BigFloat finiteDifference;
  bool sdpd_mode_exact_dSDP, sdpd_mode_dSDP_only_b,
	  sdpd_mode_hessian_ii, sdpd_mode_hessian_ij, sdpd_mode_approx_objective;

  std::vector<boost::filesystem::path> list_sdp2_path;
